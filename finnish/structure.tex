...
\newfontface\fontIIIc[Scale=1.5,Color=vapaa_matikka_vari_5]{OpenSans-Light.ttf}
\newfontface\fontIV[Scale=0.9]{OpenSans-Regular.ttf}
\newfontface\fontIVc[Scale=0.9,Color=vapaa_matikka_vari_5]{OpenSans-Regular.ttf}
...
%\newfontface\fontIIIc[Scale=1.5,Color=vapaa_matikka_vari_5]{Raleway-Light.otf}
%\newfontface\fontIV[Scale=0.9]{Raleway-Medium.otf}
%\newfontface\fontIVc[Scale=0.9,Color=vapaa_matikka_vari_5]{Raleway-Medium.otf}
...
\ifmikro
    \newpage \input{commons/finnish/donations}
\fi
