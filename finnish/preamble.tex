...
\else
    ...
    \usepackage{tgtermes} % mathptmx ongelmainen
    \usepackage{newtxmath}
    \usepackage[11pt]{moresize}
    \pdfcompresslevel=9
    \pdfpkresolution=1200
    \newcommand{\fontII}{\sffamily\fontseries{l}\fontsize{25}{19}\selectfont}
    \newcommand{\fontIII}{\sffamily\fontsize{20}{13}\selectfont}
    \newcommand{\fontIV}{\sffamily\fontsize{9}{7}\selectfont}
    \newcommand{\fontV}{\sffamily\fontsize{15}{10}\selectfont}
    \newcommand{\fontVI}{\sffamily\fontsize{16}{12}\selectfont}
\fi
...
\usepackage[nosolutionfiles]{answers} % harjoitustehtäviä varten
